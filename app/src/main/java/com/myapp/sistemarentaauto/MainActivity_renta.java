                                                                ...
                                                                if(task.getResult().isEmpty()){
                                                                    ...
                                                                    db.collection("Renta_tabla").add(renta).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                                                        ...
                                                                        public void onSuccess(DocumentReference documentReference) {
                                                                            Toast.makeText(MainActivity_renta.this, "Renta ingresada correctamente!!", Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    }).addOnFailureListener(new OnFailureListener() {
                                                                        @Override
                                                                        public void onFailure(@NonNull Exception e) {
                                                                    ...
                                                                    Toast.makeText(MainActivity_renta.this, "Renta existente, ingrese uno nuevo!!", Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                        }
                                                    });
